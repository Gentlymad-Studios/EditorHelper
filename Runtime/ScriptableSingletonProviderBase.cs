...
namespace EditorHelper {
    ...
    /// </summary>
    public abstract class ScriptableSingletonProviderBase : SettingsProvider {
        ...
        public ScriptableSingletonProviderBase(string path, SettingsScope scope = SettingsScope.User) : base(path, scope) {}
